...
class Language(models.Model):
    ...
    name = models.CharField(max_length=200, help_text="Enter a book's natural langauge")
...
class Book(models.Model):
    ...
    # Author as a string rather tahn object because it hasn't been declared yet in the file.
